...
| Source Region | Source geography. | Used for policy/governance. | Required when regional policy or data residency rules apply. | IN | Onboarding/governance. | Wrong region may trigger wrong policy. |
